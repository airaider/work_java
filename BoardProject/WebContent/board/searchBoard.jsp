...
<script type="text/javascript">
	function updateForm(){
		...
		frm.action="logcheck.do?action=updateBoardForm.do";
		frm.submit();
	}
	function deleteBoard(){
		var frm = document.getElementById("frm");
		frm.action="logcheck.do?action=deleteBoard.do";
		frm.submit();
	}
	function listBoard(){
		location.href="main.do?action=listBoard.do&${pageContext.request.queryString}";
	}
	function resetBoard(){
